...
variable "consul_image" {
  ...
  type        = string
  default     = "hashicorp/consul:1.19.2"
}
  ...
  group "gateway" {
    ...
    task "setup" {
      ...
      config {
        ...
        args = [
          "-c",
         "consul connect envoy -gateway api -register -deregister-after-critical 10s -service api-gateway -admin-bind 0.0.0.0:19000 -ignore-envoy-compatibility -bootstrap > ${NOMAD_ALLOC_DIR}/envoy_bootstrap.json"
        ]
      }
